...
func (d *dataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"status_reason":                 c("Reason for the status, if any."),
			...
			"parent_scopes":                 schema.ListAttribute{MarkdownDescription: "Parent scopes as reported by the hub.", ElementType: types.StringType, Computed: true},
		},
	}
}
