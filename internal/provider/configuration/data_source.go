...
func (d *configDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	...
	attrs := map[string]schema.Attribute{
		...
		"labels":                schema.MapAttribute{MarkdownDescription: "Labels.", ElementType: types.StringType, Computed: true},
		"metrics":               schema.MapAttribute{MarkdownDescription: "Custom metric queries by name.", ElementType: types.StringType, Computed: true},
		"schema_version":        c("Schema version, if set."),
